  ...
  return (
    <GlassCard className={`w-full max-w-md border-zinc-800 shadow-2xl rounded-3xl transition-all duration-200 ${
      ...
      <div className="mb-5 flex items-center justify-between">
        ...
        <span className="flex items-center gap-1 text-[10px] font-bold uppercase tracking-wider text-black dark:text-white">
      ...
      <div className={`transition-all duration-200 ${
        ...
        <h2 className={`font-sans font-bold tracking-tight text-slate-900 dark:text-zinc-100 transition-all duration-200 ${
            ...
            <div className="flex justify-between gap-2">
              {otp.map((digit, index) => (
                <input
                  ...
                  className="h-11 w-full rounded-full border border-zinc-800 bg-zinc-950/40 text-center text-base font-bold text-slate-900 dark:text-zinc-100 focus:border-black dark:focus:border-white focus:bg-white dark:focus:bg-zinc-900 focus:outline-none focus:ring-1 focus:ring-black dark:focus:ring-white"
                />
              ))}
            </div>
          ...
          <div className="space-y-1.5 pl-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-full border border-zinc-800 bg-zinc-950/40 py-3 pl-11 pr-11 text-xs font-medium text-slate-900 dark:text-zinc-100 placeholder-slate-400 dark:placeholder-zinc-500 transition-all focus:border-black dark:focus:border-white focus:bg-white dark:focus:bg-zinc-900 focus:outline-none focus:ring-1 focus:ring-slate-400/50"
              />
              <button
                type="button"
