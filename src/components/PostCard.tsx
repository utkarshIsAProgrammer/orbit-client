...
import { HoverLift, ScaleOnTap, AnimatedCounter } from './MotionPrimitives';
        ...
        <div className="border-t border-orbit-border bg-black/30 px-3 md:px-5 lg:px-6 py-2.5 md:py-3.5 flex items-center justify-between text-[9px] md:text-[10px] font-bold tracking-widest uppercase text-orbit-muted/80 select-none gap-1 sm:gap-2">
          <div className="flex items-center flex-wrap gap-x-1.5 sm:gap-x-2 md:gap-x-3 lg:gap-x-4">
            <ScaleOnTap>
              ...
              >
                ...
                />
                <AnimatedCounter value={post.likesCount} className="font-mono" />
              </button>
            </ScaleOnTap>
            ...
            <ScaleOnTap>
              ...
              >
                ...
                <AnimatedCounter value={post.commentsCount} className="font-mono" />
              </Link>
            </ScaleOnTap>
            ...
            <ScaleOnTap>
              ...
              >
                ...
                />
                <AnimatedCounter value={post.repostsCount} className="font-mono" />
              </button>
            </ScaleOnTap>
            ...
            <ScaleOnTap>
              ...
              >
                ...
                />
                <AnimatedCounter value={post.savesCount} className="font-mono" />
              </button>
            </ScaleOnTap>
          </div>
          ...
          <div className="flex items-center gap-1 md:gap-2 shrink-0">
            <div className="flex items-center gap-0.5 text-orbit-muted/50" title={`${post.viewsCount || 0} views`}>
              ...
              <AnimatedCounter value={post.viewsCount || 0} className="font-mono text-[9px] md:text-[10px]" />
            </div>
            <ScaleOnTap>
              <button
                onClick={handleShare}
